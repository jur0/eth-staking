...
#+LAST_MODIFIED: [2020-12-19 Sat 12:52]

* Introduction

Steps to install and configure Arch Linux server running Geth, Ethereum
2.0 beacon chain and validator along with other services for moitoring
...
| beacon    | beacon        | Ethereum 2 beacon chain   | =/home/beaon=     |
